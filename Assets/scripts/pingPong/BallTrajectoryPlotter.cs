...
public class BallTrajectoryPlotter : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        //Debug.Log($"x pos{transform.position.x}/ vel {ballVelocity.x}");

        if (PongPlayerController.LIMBSCALE == 1?ballVelocity.x<0:ballVelocity.x>0)
        {
            drawTraj();
        }
        else
